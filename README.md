# DRAFT - Angular Boot Camp Curriculum - component-hierarchy
...
[StackBlitz for component-hierarchy](https://stackblitz.io/github/AngularBootCamp/component-hierarchy)

Alternatively, you can clone the repository locally and run the
following commands:

```
git clone git@github.com:AngularBootCamp/component-hierarchy.git
cd component-hierarchy
yarn
yarn start
```
